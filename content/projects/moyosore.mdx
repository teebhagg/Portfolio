...
description: A web app that helps users to read blog posts and listen to its audio recordings.
website: https://moyo-sore.com/
github: https://github.com/teebhagg/Moyosore-Web/
techstack:
  - label: TypeScript
  - label: Next.js
  - label: TailwindCSS
