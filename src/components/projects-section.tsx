  ...
  return (
    <div className='project-section' >
      <Container maxWidth='lg' sx={{ marginTop:'250px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobileDevice? 'repeat(1, minmax(0, 1fr))': isTabletDevice? 'repeat(2, minmax(0, 1fr))' : 'repeat(3, minmax(0, 1fr))', rowGap:'40px', gap: '20px', marginTop: '50px', width:'fit-content' }} >
